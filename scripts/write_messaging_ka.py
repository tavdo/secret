...
ka = {
    ...
    "search": "\u10e9\u10d0\u10e2\u10d4\u10d1\u10d8\u10e1 \u10eb\u10d4\u10d1\u10dc\u10d0...",
    "empty": "\u10e1\u10d0\u10e3\u10d1\u10e0\u10d4\u10d1\u10d8 \u10ef\u10d4\u10e0 \u10d0\u10e0 \u10d0\u10e0\u10d8\u10e1.",
    "active": "\u10d0\u10ee\u10da\u10d0 \u10d0\u10e5\u10e2\u10d8\u10e3\u10e0\u10d8\u10d0",
    "today": "\u10d3\u10e6\u10d4\u10e1",
    "m1": "\u10d2\u10d0\u10db\u10d0\u10e0\u10ef\u10dd\u10d1\u10d0! \u10d5\u10dc\u10d0\u10ee\u10d4 \u10d7\u10e5\u10d5\u10d4\u10dc\u10d8 \u10de\u10e0\u10dd\u10e4\u10d8\u10da\u10d8 \u10d3\u10d0 \u10d3\u10d0\u10d8\u10dc\u10e2\u10d4\u10e0\u10d4\u10e1\u10d4\u10d1\u10e3\u10da\u10d8 \u10d5\u10d0\u10e0.",
    "m2": "\u10d2\u10d0\u10db\u10d0\u10e0\u10ef\u10dd\u10d1\u10d0! \u10db\u10d0\u10d3\u10da\u10dd\u10d1\u10d0 \u10db\u10d8\u10db\u10d0\u10e0\u10d7\u10d5\u10d8\u10e1\u10d7\u10d5\u10d8\u10e1. \u10e0\u10dd\u10d2\u10dd\u10e0 \u10e8\u10d4\u10db\u10d8\u10eb\u10da\u10d8\u10d0 \u10d3\u10d0\u10d2\u10d4\u10ee\u10db\u10d0\u10e0\u10dd\u10d7?",
    "m3": "\u10db\u10d8\u10dc\u10d3\u10d0 \u10ef\u10d0\u10d5\u10e8\u10d0\u10dc\u10d8 \u10ee\u10d5\u10d0\u10da \u10e1\u10d0\u10e6\u10d0\u10db\u10dd\u10e1.",
    "m4": "\u10e0\u10d0 \u10d7\u10e5\u10db\u10d0 \u10e3\u10dc\u10d3\u10d0. 20:00-\u10d8\u10e1 \u10e8\u10d4\u10db\u10d3\u10d4\u10d2 \u10d7\u10d0\u10d5\u10d8\u10e1\u10e3\u10e4\u10d0\u10da\u10d8 \u10d5\u10d0\u10e0. \u10d2\u10d8\u10ee\u10d4\u10e0\u10ee\u10d4\u10d1\u10d7?",
    "ph": "\u10d3\u10d0\u10ec\u10d4\u10e0\u10d4\u10d7 \u10e8\u10d4\u10e2\u10e7\u10dd\u10d1\u10d8\u10dc\u10d4\u10d1\u10d0...",
    "title": "\u10de\u10e0\u10d8\u10d5\u10d0\u10e2\u10e3\u10da\u10d8 \u10e8\u10d4\u10e2\u10e7\u10dd\u10d1\u10d8\u10dc\u10d4\u10d1\u10d4\u10d1\u10d8",
    "help": "\u10d0\u10d8\u10e0\u10e9\u10d8\u10d4\u10d7 \u10d7\u10d0\u10dc\u10db\u10ee\u10da\u10d4\u10d1\u10d8 \u10e3\u10e1\u10d0\u10e4\u10e0\u10d7\u10ee\u10dd \u10e1\u10d0\u10e3\u10d1\u10e0\u10d8\u10e1 \u10d3\u10d0\u10e1\u10d0\u10ec\u10e7\u10d4\u10d1\u10d0\u10d3. \u10d7\u10e5\u10d5\u10d4\u10dc\u10d8 \u10d9\u10dd\u10dc\u10e4\u10d8\u10d3\u10d4\u10dc\u10ea\u10d8\u10d0\u10da\u10e3\u10e0\u10dd\u10d1\u10d0 \u10de\u10e0\u10d8\u10dd\u10e0\u10d8\u10e2\u10d4\u10e2\u10d8\u10d0.",
    "seen": "\u00b7 \u10dc\u10d0\u10dc\u10d0\u10ee\u10d8\u10d0",
}
    ...
    <div className="pt-20 h-screen overflow-hidden flex flex-col">
      <div className="container mx-auto px-6 flex-grow flex gap-6 pb-24 md:pb-6">
        <div className={{`w-full md:w-80 lg:w-96 glass-dark rounded-3xl border-white/5 flex flex-col ${{!showMobileList ? 'hidden md:flex' : 'flex'}}`}}>
          <div className="p-6">
            <h1 className="text-2xl mb-6">{ka["messages"]}</h1>
          ...
          <div className="flex-grow overflow-y-auto px-2 no-scrollbar">
            {{MOCK_CHATS.length === 0 ? (
              <p className="px-4 py-8 text-sm text-white/40 text-center">{ka["empty"]}</p>
            ) : null}}
            {{MOCK_CHATS.map((chat) => (
              <button
                key={{chat.id}}
        ...
        <div className={{`flex-grow glass-dark rounded-3xl border-white/5 flex flex-col relative ${{showMobileList ? 'hidden md:flex' : 'flex'}}`}}>
          {{selectedChat ? (
            <>
              <div className="p-4 md:p-6 border-b border-white/5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-green-400 font-bold uppercase tracking-widest">{ka["active"]}</span>
                  </div>
                </div>
              ...
              <div className="flex-grow overflow-y-auto p-6 space-y-6 no-scrollbar">
                <div className="flex justify-center">
                  <span className="text-[10px] uppercase tracking-[0.2em] text-white/20 font-bold bg-white/5 px-4 py-1 rounded-full">{ka["today"]}</span>
                </div>
                <div className="flex flex-col gap-4">
                  <Message bubble="{ka["m1"]}" time="10:00" isOwn={{false}} />
                  <Message bubble="{ka["m2"]}" time="10:05" isOwn={{true}} />
                  <Message bubble="{ka["m3"]}" time="10:10" isOwn={{false}} />
                  <Message bubble="{ka["m4"]}" time="10:12" isOwn={{true}} />
                </div>
              </div>
            ...
            <div className="flex-grow flex flex-col items-center justify-center text-center p-12">
              ...
              <h2 className="text-2xl font-bold mb-2">{ka["title"]}</h2>
...
out = Path(__file__).resolve().parents[1] / 'src' / 'pages' / 'Messaging.jsx'
out.write_text(content, encoding='utf-8')
print('wrote', out, 'fffd' if '\ufffd' in content else 'ok')
